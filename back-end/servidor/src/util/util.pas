...
begin
  ...
  begin
    ...
    try
      ...
      begin
        Res.Status(400).Send('{"mensagem":"Tipo de pagamento não cadastrado"}')
      end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        // ------------------------------------------
        // 4. VERIFICAR SE PEDIDO-PRODUTO JÁ EXISTE
        // ------------------------------------------
