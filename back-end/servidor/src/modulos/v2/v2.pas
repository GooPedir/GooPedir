...
begin
  ...
  conexao.sql.add('where l.data_hora between "'+DataInicial+' 00:00:01" and "'+DataFinal+' 23:59:59" and l.endpoint <> "/v1/login"');
...
begin
  ...
  begin
    ...
    JSONObject.AddPair('total_total', PDV_TOT + MESA_TOT + SITE_TOT +
      IFOOD_TOT);
    ...
    begin
      conexao.SQL.Add(('select count(*) as qtd,' +
        ...
        ' from pedido where status > 0 and data_pedido between "' +
        Req.Params['dataini'] + '" and "' + Req.Params['datafim'] + '"' +
  ...
  procedure DoGetStatusSite(Req: THorseRequest; Res: THorseResponse;
    Next: TProc);
  var
    Requisicao: iRequisicao;
  begin
  ...
  begin
    ...
    conexao.SQL.Add
      ('order by nota_cliente desc, valor_total_pedidos desc, nome');
    Res.Send<TJsonArray>(conexao.ConsultaSQL);
    conexao.Free;
  ...
  begin
    ...
    try
      ...
      conexao.Parametros('complemento',
        LJsonObj.GetValue<string>('complemento'));
      conexao.ExecuteSQL;
  ...
  begin
    conexao := TConexao.Create('v2');
    conexao.SQL.Add
      ('update mesa set descricao = :descricao where id_mesa = :id');
    try
      conexao.Parametros('descricao',
  ...
  begin
    ...
    try
      ...
      try
        JsonOut.AddPair('codigo', JsonIn.GetValue('codigo')
          .Clone as TJSONValue);
  ...
  procedure DoPostGravaMesa(Req: THorseRequest; Res: THorseResponse;
    Next: TProc);
  var
    conexao: TConexao;
    JSONObject: TJSONObject;
  ...
  begin
    try
      JSONObject := TJSONObject.ParseJSONValue
        (TEncoding.UTF8.GetBytes(Req.body), 0) as TJSONObject;
  ...
  procedure DoPostZeraNFCE(Req: THorseRequest; Res: THorseResponse;
    Next: TProc);
  begin
    try
  ...
  procedure DoPostErroNFCE(Req: THorseRequest; Res: THorseResponse;
    Next: TProc);
  var
    JSONValue: TJSONValue;
    JSONObject: TJSONObject;
    ...
    try
      ...
      begin
        ...
        begin
          while not Dados.Eof do
          begin
            if Dados.FieldByName('pedido').AsString = JSONObject.Values
              ['pedido'].Value then
            begin
              PodeInserir := False;
            end;
  ...
  begin
    ...
    begin
      ...
      conexao.Parametros('html', StringReplace(Dados.FieldByName('html')
        .AsString, ProductItem.GetValue<String>('old'),
        ProductItem.GetValue<String>('new'), [rfIgnoreCase]));
      conexao.Parametros('codigo', ProductItem.GetValue<Integer>('codigo'));
      conexao.ExecuteSQL;
  ...
  procedure DoGetDadosDashBoardPrincipal(Req: THorseRequest;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        ObjPagamento.AddPair('codigo', CaixaMov.FieldByName('codigo')
          .AsInteger);
        ObjPagamento.AddPair('nome', CaixaMov.FieldByName('descricao')
          .AsString);

        if (frmServidor.Configuracoes.FieldByName('cx_resumido').AsInteger = 1)
        then
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            ObjProduto.AddPair('nome', DataProduto.FieldByName('nome')
              .AsString);
            ObjProduto.AddPair('valor',
              DataProduto.FieldByName('valor').AsFloat);
  ...
  procedure DoDeleteProduto(Req: THorseRequest; Res: THorseResponse;
    Next: TProc);
  var
    conexao: TConexao;
  begin
  ...
  begin
    ...
    conexao.Parametros('imposto',
      JSONObject.GetValue<Real>('percentualImposto'));
    ...
    conexao.Parametros('valorimposto',
      JSONObject.GetValue<Real>('valorImposto'));
  ...
  procedure DoGetParametros(Req: THorseRequest; Res: THorseResponse;
    Next: TProc);
  begin
  ...
  begin
    ...
    conexao.SQL.Add
      ('update impressao_pedido_produto set status = 0 where id in (' +
      Codigos + ')');
    conexao.ExecuteSQL;
    conexao.Free;
  ...
  begin
    ...
    conexao.SQL.Add
      ('       group_concat(produto.nome_produto," ") as produto ');
  ...
  procedure DoPostRegistro(Req: THorseRequest; Res: THorseResponse;
  Next: TProc);
  var
    Usuario: TJSONObject;
    conexao: TConexao;
...
begin
  ...
  procedure DoPostPedidoProdutosSeleciona(Req: THorseRequest;
  Res: THorseResponse; Next: TProc);
  var
    conexao: TConexao;
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Unitario :=
            ((Banco.FieldByName('valor_unitario').AsFloat / QUANTIDADE) *
          ...
          conexao.Parametros('codigo', Codigo);
          conexao.Parametros('codigo_pedido', CodigoPedido);
          conexao.Parametros('codigo_produto',
            Banco.FieldByName('codigo_produto').AsInteger);
          conexao.Parametros('valor_unitario', Unitario);
          conexao.Parametros('quantidade', QuantidadeTransferencia);
          conexao.Parametros('valor_total', Total);
          conexao.Parametros('valor_adicional', Adicional);
  ...
  begin
    ...
    conexao := TConexao.Create('v2');
    Res.Send(conexao.GerarID(Req.Params['tabela'], Req.Params['campo'])
      .ToString);
    conexao.Free;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        begin
          conexao.SQL.Add('(' + CampoInsert + ') values (' +
            ValuesInsert + ') ')
        end;
        // conexao.SQL.Add('insert into ' + Tabela);
        conexao.ExecuteSQL;
  ...
  procedure DoPostUserAgent(Req: THorseRequest; Res: THorseResponse;
  Next: TProc);
  var
    conexao: TConexao;
  ...
  procedure DoGetFidelidadeHistoricoSite(Req: THorseRequest;
  Res: THorseResponse; Next: TProc);
  var
    Requisicao: iRequisicao;
    Dados: TFDMemTable;
  ...
  procedure DoGetRelatorioProdutosPeriodo(Req: THorseRequest;
  Res: THorseResponse; Next: TProc);
  var
    conexao: TConexao;
    JSONObject: TJSONObject;
  ...
  begin
    ...
    conexao.SQL.Add(CriaSubQueryCampos(SQL,
      ...
      JSONObject.GetValue('inicial').Value,
      JSONObject.GetValue('final').Value));
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          Dados.FieldByName('cliente').AsString := Dados.FieldByName('desc_ficha').AsString;
        end;
  ...
  begin
    ...
    THorse.Post('/v2/produtos/entrada/saida/:codigo',
      DoPostProdutoEntradaSaida);
    ...
    THorse.Get('/v2/consulta/clientes/fiado/:busca',
      DoGetConsultaClientesFiado);
