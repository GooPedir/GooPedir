object frmACBrNFe: TfrmACBrNFe
  ...
  object iEmissao: iRequisicao
    ...
    URL = 'nfce/emissao'
    MemTable2 = dadosEmissao
    eTAG = False
    Metodo = mGet
    Status = 0
    MostrarAguarde = False
    TempoExpiracao = 15000
    Left = 814
    Top = 286
  end
  object dadosEmissao: TFDMemTable
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ResourceOptions.AssignedValues = [rvSilentMode]
    ResourceOptions.SilentMode = True
  ...
  object iContabilidade: iRequisicao
    BaseURL = 'http://127.0.0.1:2121/'
    URL = 'nfce/notas/sinc'
    MemTable2 = dadosCode
    eTAG = False
  ...
  object notasContabilidade: TFDMemTable
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ResourceOptions.AssignedValues = [rvSilentMode]
    ResourceOptions.SilentMode = True
