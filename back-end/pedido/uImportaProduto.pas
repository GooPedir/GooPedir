    ...
    begin
      ...
      begin
        ...
        Conexao.SQL.Add('insert into pro_adi_personalizado ' +
          '(id, id_produto, descricao, ativo, qtd_minima, qtd_maxima, id_site, modificado_site, id_extra, id_ifood, deletado) '
          + 'values (:id, :id_produto, :descricao, :ativo, :qtd_minima, :qtd_maxima, :id_site, :modificado_site, :id_extra, :id_ifood, :deletado)');
        Conexao.Parametros('id', CatIdLocal);
      end
      else
      begin
        Conexao.SQL.Clear;
        Conexao.SQL.Add('update pro_adi_personalizado set deletado = :deletado,'
      ...
      Conexao.Parametros('deletado', GetStr(OCat, 'deletado'));
        ...
        begin
          ...
          begin
            ...
            Conexao.SQL.Add('insert into pro_adi_personalizado_sabores ' +
              ...
              + '  id_ingredientes, quantidade_ingredientes, id_ifood, id_prod_estoque,deletado) '
          ...
          begin
            Conexao.SQL.Clear;
            Conexao.SQL.Add
              ('update pro_adi_personalizado_sabores set deletado = :deletado, '
          ...
          Conexao.Parametros('deletado', GetInt(OItem, 'deletado'));
    ...
    for I := 0 to Arr.Count - 1 do
      ...
      begin
        ...
        begin
          ...
          Conexao.SQL.Clear;
          Conexao.SQL.Add
            ('insert into sabores_completo (id,id_produto,dt_cadastro,nome,descricao,vl_venda,ativo,id_site,url,id_tipo_sabor,deletado)');
          Conexao.SQL.Add
            ('values (:id,:id_produto,curdate(),:nome,:descricao,:vl_venda,:ativo,:id_site,:url,:id_tipo_sabor,:deletado)');
          Conexao.Parametros('id', CodSabor);
          Conexao.Parametros('id_produto', ACodProd);
          ...
          Conexao.Parametros('deletado', GetInt(OSabor, 'deletado'));
        ...
        begin
          ...
          Conexao.SQL.Add('       deletado   = :deletado,');
...
begin
  ...
  begin
    Conexao.SQL.Clear;
    Conexao.SQL.Add
      ('update produto set deletado = :deletado, nome_produto=:nome_produto, descricao=:descricao, codigo_grupo=:codigo_grupo, position=:ordem,');
    Conexao.SQL.Add
