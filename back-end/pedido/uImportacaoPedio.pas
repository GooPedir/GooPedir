...
function GetCodigoProduto(CodigoSite: Integer; NomeProduto: String): Integer;
...
begin
  ...
  try
    ...
    Conexao.SQL.Add
      ('update produto set id_site = :site where codigo = :codigo');
    Conexao.Parametros('site', CodigoSite);
    Conexao.Parametros('codigo', Result);
    Conexao.ExecuteSQL;
  except
    Result := 0;
  end;
...
begin
  ...
  try
    ...
    try
      ...
      // Importante: liberar apenas o nó raiz; os filhos são owned por ele
      LRootVal.Free;
    end;
...
begin
  ...
  // Inserir os produtos
  InserirProduto(Produtos, Cliente.Mesa, Cliente.PedidoMesa, Conexao, Usuario);
