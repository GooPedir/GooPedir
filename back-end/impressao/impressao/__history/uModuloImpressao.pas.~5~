...
type
  ...
  TdmImpressaoV2 = class(TDataModule)
    ...
    ppRichText43: TppRichText;
    ppSummaryBand5: TppSummaryBand;
    ppGroup4: TppGroup;
    ppGroupHeaderBand4: TppGroupHeaderBand;
    ppRichText44: TppRichText;
    ...
    qryFechamentoCaixaCabechado: TFDQuery;
    dsFechamentoCaixaCabechado: TDataSource;
    ppFechamentoCaixaCabechado: TppBDEPipeline;
    CAIXA80MM: TppReport;
    ppParameterList2: TppParameterList;
    ppHeaderBand2: TppHeaderBand;
    ppRichText15: TppRichText;
    ppDetailBand2: TppDetailBand;
    ppFooterBand2: TppFooterBand;
    ppSummaryBand9: TppSummaryBand;
    ppDesignLayers12: TppDesignLayers;
    ppDesignLayer14: TppDesignLayer;
    IMPRESSAO: TFDMemTable;
    IMPRESSAOID: TIntegerField;
    IMPRESSAODATA_HORA: TDateTimeField;
    IMPRESSAOTIPO: TStringField;
    IMPRESSAORELATORIO: TStringField;
    IMPRESSAOSTATUS: TIntegerField;
    IMPRESSAODESCRICAO: TStringField;
    IMPRESSAOCODIGO: TIntegerField;
    IMPRESSAODRIVER: TStringField;
    IMPRESSAOOBSERVACAO: TStringField;
    ppGroup2: TppGroup;
    ...
    ppRichText25: TppRichText;
    ppFooterBand4: TppFooterBand;
    ppSummaryBand15: TppSummaryBand;
    ppLabel1: TppLabel;
    ppRichText26: TppRichText;
    ppDBText3: TppDBText;
    ppLabel11: TppLabel;
    ppDBText4: TppDBText;
    ppLabel36: TppLabel;
    ...
    ppRichText28: TppRichText;
    ppRichText31: TppRichText;
    ppDBCalc1: TppDBCalc;
    ppLabel4: TppLabel;
    ppLine4: TppLine;
    ...
    ppLine9: TppLine;
    ppRichText38: TppRichText;
    ppDetailBand8: TppDetailBand;
    ppRichText39: TppRichText;
    ppFooterBand6: TppFooterBand;
    ppSummaryBand2: TppSummaryBand;
    ppRichText40: TppRichText;
    ppLabel9: TppLabel;
    ppDBText12: TppDBText;
    ppLine21: TppLine;
    ppGroup9: TppGroup;
    ppGroupHeaderBand9: TppGroupHeaderBand;
    ppRichText46: TppRichText;
    ppGroupFooterBand9: TppGroupFooterBand;
    ppLine22: TppLine;
    ppRichText47: TppRichText;
    ppDesignLayers7: TppDesignLayers;
    ppDesignLayer7: TppDesignLayer;
    ppParameterList6: TppParameterList;
    ppParameter6: TppParameter;
    CAIXA_RESUMO: TFDQuery;
    ...
    CAIXA_COMPLETO80MM: TppReport;
    ppTitleBand9: TppTitleBand;
    ppRichText54: TppRichText;
    ppLabel17: TppLabel;
    ppLabel18: TppLabel;
    ppRichText55: TppRichText;
    ppLabel19: TppLabel;
    ppLabel20: TppLabel;
    ppRichText56: TppRichText;
    ppRichText57: TppRichText;
    ...
    ppMotoboy: TppBDEPipeline;
    dsMotoboy: TDataSource;
    CAIXA_MOTOBOY80MM: TppReport;
    ppTitleBand10: TppTitleBand;
    ppRichText59: TppRichText;
    ppLabel21: TppLabel;
    ...
    ppLabel30: TppLabel;
    ppDBCalc7: TppDBCalc;
    CAIXA_PRODUTO: TFDQuery;
    ppProduto: TppBDEPipeline;
    ...
    ppLabel52: TppLabel;
    ppRichText75: TppRichText;
    ppLabel53: TppLabel;
    ppLabel54: TppLabel;
    ppRichText76: TppRichText;
    ppRichText77: TppRichText;
    ppDesignLayers15: TppDesignLayers;
    ppDesignLayer15: TppDesignLayer;
    ppParameterList13: TppParameterList;
    ppParameter12: TppParameter;
    CAIXA_MOTOBOY56MM: TppReport;
    ppTitleBand14: TppTitleBand;
    ppRichText78: TppRichText;
    ppLabel55: TppLabel;
    ...
    ppPageSummaryBand5: TppPageSummaryBand;
  ...
  public
    ...
    procedure ImprimeNFCe(URL, Driver, Arquivo: String);
    function FormatarNumero(Numeros: string): string;
  end;
...
procedure TdmImpressaoV2.ConfiguraReport(Relatorio: TppReport);
begin
  ...
  try
    ...
    // 'Rigth '+Relatorio.PrinterSetup.MarginRight.ToString+#13
    // );
...
begin
  ...
  ppLabel11.Visible := Origem <> 3;
  ppDBText4.Visible := Origem <> 3;
  ppRichText27.Visible := Origem <> 3;
  ppLabel38.Visible := Origem <> 3;
  ppDBText34.Visible := Origem <> 3;
  ppDBText35.Visible := Origem <> 3;
  // ppDB2DBarCode3.Visible := Origem <> 3;
  // ppShape2.Visible := Origem <> 3;
  // ppDB2DBarCode6.Visible := Origem <> 3;
  // ppShape6.Visible := Origem <> 3;
  // ppLabel39.Visible := Origem <> 3;
  // ppLabel40.Visible := Origem <> 3;
  // ppSystemVariable8.Visible := Origem <> 3;
...
function TdmImpressaoV2.GetVersaoArq: string;
var
  VerInfoSize: DWORD;
  VerInfo: Pointer;
  VerValueSize: DWORD;
...
procedure TdmImpressaoV2.IMPRESSAOAfterInsert(DataSet: TDataSet);
begin
...
// begin
// Driver := DADOS.FieldByName('driver').AsString;
// if Driver = '' then
// Driver := Impressoras.FieldByName('driver').AsString;
//
// try
// ImprimeNFCe(DADOS.FieldByName('caminho').AsString, Driver,
// DADOS.FieldByName('path').AsString);
// except
// on E: Exception do
// begin
// // //showmessage(E.Message);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        try
          ImprimeNFCe(frmMain.urlServer + 'impressao/xml/nfce/' +
            DADOS.FieldByName('chave').AsString, Driver,
            DADOS.FieldByName('path').AsString);
          AddImpressao('NFCE', nil, DADOS.FieldByName('id_pedido').AsInteger, 1,
            'IMPRESSO', '', Impressoras.FieldByName('driver').AsString);
        except
        ...
        3:
          begin
            case Impressoras.FieldByName('tipo_impressao').AsInteger of
              0:
                begin
                  Relatorio := dmImpressaoV2.CAIXA_RESUMO56MM;
                end
            else
              begin
        ...
        4:
          begin
            case Impressoras.FieldByName('tipo_impressao').AsInteger of
              0:
                begin
                  Relatorio := dmImpressaoV2.CAIXA_COMPLETO56MM
                end
            else
              begin
        ...
        5:
          begin
            case Impressoras.FieldByName('tipo_impressao').AsInteger of
              0:
                begin
                  Relatorio := dmImpressaoV2.CAIXA_PRODUTO56MM;
                end
            else
              begin
        ...
        6:
          begin
            case Impressoras.FieldByName('tipo_impressao').AsInteger of
              0:
                begin
                  Relatorio := dmImpressaoV2.CAIXA_MOTOBOY56MM;
                end
            else
              begin
