        ...
        try
          ...
          begin
            ...
            begin
              ...
              CodigoExtra := InserirUpdate('ws_adicionais_cat', UserID.ToString,
                ['id', 'user_id', 'pay', 'img_cat', 'id_itens', 'id_cat',
                'name_adicionais_cat', 'minimo', 'amount'],
                [DadosExtra.FieldByName('id_site').AsWideString,
                UserID.ToString, '1', '', Result.ToString,
                DadosExtra.FieldByName('id_site').AsWideString,
              ...
              begin
                ...
                begin
                  Codigo := InserirUpdate('ws_adicionais_itens',
                    UserID.ToString, ['id_adicionais', 'user_id',
                    'categorias_adicional', 'id_adicionais_cat',
                    'medida_adicional', 'nome_adicional', 'valor_adicional',
                    'status_adicional', 'descricao'],
                    [DadosExtraItem.FieldByName('id_site').AsWideString,
                    UserID.ToString, DadosExtra.FieldByName('id_site')
                    .AsWideString, CodigoExtra.ToString, 'UN',
