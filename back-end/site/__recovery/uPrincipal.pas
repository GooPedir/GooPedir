  ...
  try
    ...
    begin
      ...
      begin
        ...
        if Sabor > 0 then
        begin
          // Primeiro verifico a existencia se o produto é uma pizza
          // Obrigatorio
...
const
  ...
  SemAcento = 'àâêôûãõáéíóúçüñýÀÂÊÔÛÃÕÁÉÍÓÚÇÜÑÝ';
var
  X: Cardinal;
begin;
...
begin
  ...
  begin
    ...
    frmPrincipal.memRequisicoes.FieldByName('URL').AsString := 'Sem Conexão';
...
begin
  ...
  // Código é os registros que foram alterados
  codigo := StringReplace(codigo, '"', '', [rfReplaceAll]);
  ...
  // Códigos é os registros que ja tem no sistema
