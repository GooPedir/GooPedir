...
uses
  ...
  Data.FireDACJSONReflect
    in '..\servidor\src\other\Data.FireDACJSONReflect.pas',
  ...
  Horse.BasicAuthentication
    in '..\servidor\src\other\Horse.BasicAuthentication.pas',
  ...
  Horse.Core.Group.Contract
    in '..\servidor\src\other\Horse.Core.Group.Contract.pas',
  ...
  Horse.Core.Route.Contract
    in '..\servidor\src\other\Horse.Core.Route.Contract.pas',
  ...
  Horse.Provider.Abstract
    in '..\servidor\src\other\Horse.Provider.Abstract.pas',
  ...
  Horse.Provider.FPC.Apache
    in '..\servidor\src\other\Horse.Provider.FPC.Apache.pas',
  Horse.Provider.FPC.CGI in '..\servidor\src\other\Horse.Provider.FPC.CGI.pas',
  Horse.Provider.FPC.Daemon
    in '..\servidor\src\other\Horse.Provider.FPC.Daemon.pas',
  Horse.Provider.FPC.FastCGI
    in '..\servidor\src\other\Horse.Provider.FPC.FastCGI.pas',
  Horse.Provider.FPC.HTTPApplication
    in '..\servidor\src\other\Horse.Provider.FPC.HTTPApplication.pas',
  ...
  Horse.WebModule
    in '..\servidor\src\other\Horse.WebModule.pas' {HorseWebModule: TWebModule} ,
  ...
  ThirdParty.Posix.Syslog
    in '..\servidor\src\other\ThirdParty.Posix.Syslog.pas',
