...
begin
  ...
  InserirUpdate('ws_pedidos_motoboy ', DadosEmpresa.FieldByName('user_id')
    ...
    memDadosMotoboy.FieldByName('id').AsString, Status.ToString, StrList[0],
...
procedure TfrmPrincipalMotoboy.Rectangle2Click(Sender: TObject);
begin
...
procedure TfrmPrincipalMotoboy.Rectangle3Click(Sender: TObject);
begin
  rStatus.Visible := False;
  rEntrega.Visible := False;
  InserirStatus(2);
...
procedure TfrmPrincipalMotoboy.Rectangle4Click(Sender: TObject);
begin
  rStatus.Visible := False;
  rEntrega.Visible := False;
  TabControl1.TabIndex := 0;
