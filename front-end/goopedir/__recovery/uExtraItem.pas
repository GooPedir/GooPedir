...
begin
  ...
  begin
    ...
    begin
      ...
      DADOS.FieldByName('ingredientes').AsInteger := Extra.GetCodigoIngredienteSelecionado;
      DADOS.FieldByName('quantidade').AsFloat := Extra.GetQuantidadeIngredienteSelecionado;
...
begin
  ...
  frmSimNao.Descricao := 'Deseja copiar o extra "' + DADOEXTRA.FieldByName
    ('extra').AsString + '"?';
