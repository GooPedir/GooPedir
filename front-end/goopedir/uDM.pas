...
type
  ...
  TDM = class(TDataModule)
    ...
    DADOS_WHATSAPPimpressao_agrupada: TIntegerField;
    DADOS_WHATSAPPfidelidade: TIntegerField;
    DADOS_WHATSAPPfidelidade_pontos_eq_valor: TFloatField;
    DADOS_WHATSAPPfidelidade_valor_eq_pontos: TFloatField;
    DADOS_WHATSAPPfidelidade_pedido_minimo: TFloatField;
    DADOS_WHATSAPPfidelidade_pedido: TIntegerField;
    DADOS_WHATSAPPfidelidade_wpp: TIntegerField;
    DADOS_WHATSAPPfidelidade_site: TIntegerField;
    DADOS_WHATSAPPfidelidade_tipo: TIntegerField;
    DADOS_WHATSAPPfidelidade_qtd_resgate: TIntegerField;
    DADOS_WHATSAPPfidelidade_valor_real: TFloatField;
    ...
    DADOS_MOTOBOY_PEDIDOddd_padrao: TStringField;
    DADOS_WHATSAPPaceitar_pedidos_ifood: TIntegerField;
    DADOS_WHATSAPPifood_percentual: TFloatField;
...
begin
  ...
  try
    ...
    Body := '{' + #13 + '"client_id":"' + DADOS_WHATSAPP.FieldByName
      ('client_id').AsString + '",' + #13 + '"client_security":"' +
